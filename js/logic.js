        ...
        window.updateBonusButton = function() {
            ...
            // Show bonus button if they marked a card as incorrect, OR they just want to use it
            // Let's make it always visible if they haven't exhausted bonus cards.
        ...
        window.renderSingleCard = function(cardObj, idx) {
            ...
            var numberBadge = <div class="absolute -top-3 -left-3 w-8 h-8 md:w-10 md:h-10 bg-slate-800 border-2 border-white rounded-full flex items-center justify-center text-white font-black text-sm md:text-xl shadow-lg z-[70] tarot-font"></div>;
            ...
            inner.innerHTML = 
                ...
                <div class="absolute inset-0 backface-hidden rounded-xl card-cover flex flex-col justify-center items-center p-2 border-[4px] md:border-[6px] bg-slate-800 transition-all duration-300 ">
